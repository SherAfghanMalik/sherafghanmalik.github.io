export const researchAreas = [
  { number: "01", title: "Algorithmic Differentiation", summary: "Forward/tangent and reverse/adjoint modes for efficiently computing sensitivities in numerical programs and neural networks.", topics: ["dco/c++", "Higher-order derivatives", "C++"] },
  ...
  { number: "03", title: "Structured Neural-Network Pruning", summary: "Derivative-informed ranking of neurons and CNN channels to produce smaller models with practical structured reductions.", topics: ["Deep neural networks", "MLPs", "CNNs", "PyTorch"] },
