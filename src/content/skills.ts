export const skillGroups = [
  ...
  { title: "ML & scientific computing", skills: ["PyTorch · TensorFlow / Keras", "Algorithmic differentiation", "Neural-network pruning", "Scientific ML", "Numerical methods", "Sensitivity analysis"] },
