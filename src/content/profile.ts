export const profile = {
  ...
  intro: "I implement mathematical and machine-learning methods as reliable research software—from C++ automatic differentiation and interval algorithms to PyTorch and TensorFlow/Keras studies on GPU/HPC systems.",
